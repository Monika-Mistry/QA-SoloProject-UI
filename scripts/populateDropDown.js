...
const getAllGenre = "http://localhost:8080/netflixWatchlistApp/api/genre/getAllGenres";
const getAllTitle = "http://localhost:8080/netflixWatchlistApp/api/netflix/getAllProgrammes";
